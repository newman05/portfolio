...
export const links = [
  {
    name: "GitHub",
    url: "https://github.com/newman05",
    // Use a GitHub mark logo image instead of the user avatar
  ...
  {
    name: "Codeforces",
    url: "https://codeforces.com/profile/nmn_",
    description: <>
      <span className="text-[#72FF72] font-semibold">Pupil</span> Max:1202
    </>,
  ...
  {
    name: "Codechef",
    url: "https://www.codechef.com/users/sap31",
    description: (
      <>
        <Image
          src="/threestar.png"
      ...
      //<span className="text-[#3366CC] font-semibold">3 star</span> 
    ),
    image: "/codechef.jpeg",
  },
  {
    name: "LeetCode",
    url: "https://leetcode.com/nmn_",
    description: (
      <>
        Solved over <span className="font-bold">450+</span> problems on LeetCode
      </>
    ),
    logo: (
